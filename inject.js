...
function encrypttext(){
    // get message content
    let messageToEncrypt = document.getElementById('extensionEncryptTextbox').value
    ...
    document.getElementById('extensionEncryptTextbox').value = ''
    ...
    currentURL = currentURL.replace(/https\:\/\/discord.com\/channels\/\@me\//gi, '');
    
    let message = encryptedMessage;
    let channel_id = currentURL;
...
//     document.getElementById('decryptbtn').addEventListener('click', decrypttext)
    ...
    waitForElement('[role=textbox]', 0).then(function(){
        ...
        var buttons = document.getElementsByClassName('buttons-3JBrkn')[0]
        console.log(buttons)
...
chrome.runtime.onMessage.addListener(function (request, sender, sendResponse) {
  ...
  init()
  //if (document.location.href.replace(/https\:\/\/discord.com\/channels\/\@me\//gi, '') == 'CHANNEL ID FROM CHROME STORAGE')
})
